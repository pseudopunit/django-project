...
from .detail import EMAIL_USE_TLS, EMAIL_HOST, EMAIL_HOST_USER, EMAIL_HOST_PASSWORD, EMAIL_PORT
...
SECRET_KEY = 'you don\'t have permission to see my security key'
...
INSTALLED_APPS = [
    ...
    'django_extensions',
    'unesco.apps.UnescoConfig',  # Add for unescoSqlAssignment
    'crispy_forms',
    'rest_framework',
    'social_django',
